...
@section('content')
<div class="card-agendamentos-container d-flex justify-content-center">
    <div class="card card-agendamentos mt-3 w-100">
        <div class="card-body">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <h3 class="mt-lg-0 mt-3 mb-4"><b>Selecionar opções</b></h3>
