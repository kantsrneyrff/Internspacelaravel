...
@section('title', 'Confirmar Agendamentos')
                ...
                <table id="tabela" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex">
                                <button type="button" agendamento="{{json_encode($agendamento)}}" onclick="mostrarAprovar(<?php echo $agendamento->id ?>)" id="btnAprovar{{$agendamento->id}}" class="btn btn-success me-2"><i class="fa-solid fa-check"></i></button>
                                <button type="button" agendamento="{{json_encode($agendamento)}}" onclick="mostrarRecusar(<?php echo $agendamento->id ?>)" id="btnRecusar{{$agendamento->id}}" class="btn btn-danger"><i class="fa-solid fa-x"></i></button>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">
                    <p id="tituloModal">Aprovar Agendamento?</p>
                </h5>
            ...
            <div class="modal-footer" id="modalFooter">
                <form action="{{route('agendamentos-updateAprovado')}}" id="formAprovar" method="POST">
                    @csrf
...
<div class="modal fade" id="modalRecusado" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">
                    <p id="tituloModal">Recusar Agendamento?</p>
                </h5>
            ...
            <div class="modal-footer" id="modalFooter">
                <form action="{{route('agendamentos-updateRecusado')}}" id="formRecusar" method="POST">
                    @csrf
